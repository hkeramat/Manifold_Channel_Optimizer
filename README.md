## This repository contains an optimization framework based on evolutionary algorithms (genetic) and a surrogate model (Gaussian Process Regression) for a 3D MMHX. 
